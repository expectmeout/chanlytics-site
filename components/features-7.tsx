        ...
        <section className="overflow-hidden py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-12">
                <div className="relative z-10 max-w-2xl">
                    <h2 className="text-4xl font-semibold lg:text-5xl">Marketplace Complexity, Mastered In-House</h2>
                    <p className="mt-6 text-lg">Our in-house team of veteran strategists and technical experts manages every mission-critical function—supply chain automation, advanced PPC, compliance, and creative optimization—ensuring seamless execution and measurable growth for sophisticated brands.</p>
                </div>
