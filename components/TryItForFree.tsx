...
export default function TryItForFree() {
  ...
  return (
    <section className='py-24 border-t border-white/10'>
      <div
        className='overflow-x-clip p-4 flex border border-white/10'
        ref={sectionRef}
        ...
        >
          {Array.from({ length: 10 }).map((_, index) => (
            <div key={index} className='flex items-center gap-16'>
              <span className='text-7xl bg-gradient-to-r from-blue-500 to-teal-400 text-transparent bg-clip-text'>&#10038;</span>
              <span className='bg-gradient-to-r from-blue-500 to-teal-400 text-transparent bg-clip-text group-hover:opacity-90'>Try it for free</span>
            </div>
          ))}
        </motion.div>
