...
const processSteps: ProcessStep[] = [
  {
    ...
    details: [
      "In-depth audit of current Amazon/Walmart marketplace accounts and performance metrics.",
      "Analysis of operational workflows, pain points, and bottlenecks to address.",
      "Collaborative goal setting for VA support, advertising, and business growth objectives.",
  ...
  },
  {
    ...
    description: "Building your dedicated team of specialized VAs and integrating our systems.",
    details: [
      "Recruitment and rigorous training of your dedicated VAs specialized in inventory management, listing optimization, and customer service.",
      "Integration with your existing CRM tools (Monday.com, Excel, etc.) and setup in our proprietary workflow system.",
      "Configuration of performance tracking dashboards and reporting frameworks.",
      "Setup of initial operational procedures and handover protocols.",
    ],
  ...
  },
  {
    ...
    description: "Connecting your AI assistant to unify all marketplace data.",
    details: [
      "Custom ChatGPT plugin configuration connected directly to your Amazon seller account.",
      "Creation of tailored prompts specific to your business questions and reporting needs.",
      "Setup of real-time access to performance metrics and VA task tracking.",
      "Training on how to use AI to make data-driven decisions faster and automate tedious tasks.",
    ],
  ...
  },
  {
    ...
    details: [
      "Daily task management and quality assurance for VA operations with transparent reporting.",
      "Ongoing monitoring of marketplace performance with actionable insights.",
      "Regular performance reviews with your dedicated account manager to ensure continuous improvement.",
      "Strategy adjustments based on market changes and emerging opportunities.",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Scaling VA resources and adapting team structure as your business grows.",
      "Quarterly business reviews with ROI tracking on all strategic initiatives.",
    ],
