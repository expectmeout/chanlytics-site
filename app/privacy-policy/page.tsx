    ...
    <div className="bg-background text-foreground py-16 md:py-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <article className="prose prose-invert lg:prose-xl mx-auto">
          <h1>Privacy Policy for Chanlytics</h1>
          <p className="text-sm text-gray-400">Last updated: June 24, 2025</p>
          ...
          <h2>Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, You can contact us via email at <a href="mailto:sales@chanlytics.com" className="text-blue-400 hover:underline">sales@chanlytics.com</a></p>
        </article>
      </div>
    </div>
  );
