  ...
  return (
    <div className="bg-white text-gray-800 py-12">
      <div className="container mx-auto px-6 md:px-12">
        <h1 className="text-4xl font-bold mb-6">Privacy Policy for Chanlytics</h1>
        <p className="mb-4 text-sm text-gray-600">Last updated: June 24, 2025</p>
        ...
        <div className="space-y-8">
          <div>
            ...
            <ul className="list-disc list-inside mb-4 space-y-2 pl-4">
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Chanlytics.</li>
          ...
          <div>
            ...
            <p>If you have any questions about this Privacy Policy, You can contact us via email at <a href="mailto:sales@chanlytics.com" className="text-blue-600 hover:underline">sales@chanlytics.com</a></p>
          </div>
        </div>
      </div>
    </div>
